...
\hfill
{\small\zihao{-5}\songti{陈庭强,等:多因素耦合下CRT市场信用风险传染的熵空间模型}
 }\hfill}}

%---------------------------首页页眉---------------------------------
\vspace*{-13mm} \thispagestyle{empty} \noindent \hbox to
\textwidth{\small{\zihao{-5}\songti 第}\,\,XX\,{\zihao{-5}\songti
卷 第}\,\,X\,{\zihao{-5}\songti 期}\hfill {\zihao{5}
系统工程理论与实践}\hfill Vol.XX, No.X} \vskip -0.2mm
\par\noindent
\hbox to \textwidth{\small 20XX {\zihao{-5}\songti 年}\,\,X
{\zihao{-5}\songti 月}\hfill Systems Engineering --- Theory \&
Practice\hfill X., 20XX} \vskip -0.3mm
\par\noindent
\rule[2mm]{\textwidth}{0.5pt}\hspace*{-\textwidth}\rule[1.5mm]{\textwidth}{0.5pt}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\ziju{0.025} \vskip -7mm  \noindent {\small doi:\
10.12011/1000-6788(20XX)XX-XXXX-XX \qquad \qquad {中图法分类号:}\ \ XXX %中图分类号从《中国图书馆分类法》(第四版)中查得。
\qquad\qquad{文献标志码:\ \ A}}

%-----------------------脚注--------------------------------------------------
\footnotetext{{\HT 收稿日期:}\ 20XX-XX-XX} \footnotetext{{\HT
作者简介:}\
陈庭强(1983--),男,河南信阳人,博士后,博士,讲师,研究方向:金融工程与风险管理,
E-mail: xx@xx.edu.cn;
李心丹(1966--),男,湖南浏阳人,教授,博导,研究方向:金融市场;王冀宁(1965--),男,河北人,教授,研究方向:金融与证券投资.}
\footnotetext{{\HT 基金项目:}\ 国家自然科学基金(71501094)}
\footnotetext{{\HT Foundation item:}\ National Natural Science
Foundation of China (71501094)}\footnotetext{{\HT 中文引用格式:}\
陈庭强,李心丹,王冀宁.多因素耦合下CRT市场信用风险传染的熵空间模型[J].系统工程理论与实践,
20XX, XX(X): X--X.} \footnotetext{{\HT 英文引用格式:}\ Chen T Q,
Li X D, Wang J N. Spatial interaction theory-based credit risk
contagion model under multi-factor coupling for the CRT market[J].
Systems Engineering --- Theory \& Practice, 20XX, XX(X): X--X.}

%---------------------题目、作者、单位、摘要、关键词, 中图分类号(必须提供)------------------
%\SEC{中文题目}{作者}{单位}
\SEC{多因素耦合下CRT市场信用风险传染的熵空间模型}
{陈庭强$^{1,2}$,李心丹$^{2}$,王冀宁$^{1}$} {(1. 南京工业大学\
经济与管理学院, 南京 211816; 2. 南京大学\ 工程管理学院, 南京
210093)}
...
%%%%%%%%%%%%%%%英文部分%%%%%%%%%%%%%%%%%%%%%%%
%\ESEC{英文题目}{作单}{单位}
\ESEC{Spatial interaction theory-based credit risk contagion model
under multi-factor coupling for the CRT market} {CHEN
Tingqiang$^{1,2}$, \ LI Xindan$^{2}$, \ WANG Jining$^{1}$} {(1.
School of Economics and Management, Nanjing Tech University,
Nanjing 211816, China; 2. School of Management and Engineering,
...
\begin{table}[htbp]
  \centering
  \caption{Add caption}
  \tabcolsep  15pt   %调整表格列宽
  \renewcommand \arraystretch {1.5} %调整表格高度
    \begin{tabular}{|c|c|c|c|c|c|}
    \hline
    \multicolumn{2}{|c|}{} & 1     & 2     & 3     & 4 \\
    \hline
    \multirow{2}[4]{*}{5} & 5     & 8     & 10    & 12    & 14 \\
\cline{2-6}          & 7     & 9     & 11    & 13    & 15 \\
    \hline
    \multirow{2}[4]{*}{1} & 2     & 4     & 6     & 8     & 10 \\
\cline{2-6}          & 3     & 5     & 7     & 9     & 11 \\
    \hline
    \end{tabular}%
  \label{tab:addlabel}%
\end{table}%
...
\REF{[1]} 陈庭强,李心丹,王冀宁.
多因素耦合下CRT市场信用风险传染的熵空间模型[J].
系统工程理论与实践, 2016, 36(1): 1--14. \\
Chen T Q, Li X D, Wang J N. Spatial interaction theory-based credit risk contagion model under multi-factor coupling for the CRT market[J]. Systems Engineering --- Theory \& Practice, 2016, 36(1): 1--14.%期刊著录格式
